...
- **设计风格**: Luxury / Editorial（奢侈杂志风）
- **字体**: Playfair Display（衬线标题）+ Inter（无衬线正文），通过 `next/font/google` 加载
...
| 设计风格 | Luxury / Editorial | 暖白/炭黑/金色调色板，零圆角，慢速动画，不对称网格 |
| 字体方案 | Playfair Display + Inter | 衬线用于标题创造杂志感，无衬线用于正文保证可读性 |
