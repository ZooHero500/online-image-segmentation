...
// Map pSEO slugs to their focused editor preset URLs.
const TOOL_SLUG_HREF: Record<string, string> = {
  ...
  "crop-image": "/resize",
  "crop-for-instagram": "/resize?crop=instagram-post",
  "instagram-story-crop": "/resize?crop=instagram-story",
  "youtube-thumbnail-crop": "/resize?crop=youtube-thumbnail",
}

export function ToolLanding({ data, locale, t }: ToolLandingProps) {
  const hasFaq = data.faqEntries.length > 0
  const toolHref = TOOL_SLUG_HREF[data.slug]
  ...
  return (
    <main className="min-h-screen bg-background relative">
      ...
      {/* UPLOAD — pSEO wrappers deep-link to focused editors; split tools show inline splitter. */}
