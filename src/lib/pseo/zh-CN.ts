...
const data: Record<string, ToolPageData> = {
  ...
  "crop-image": {
    slug: "crop-image",
    category: "use-case",
    seo: { title: "在线裁剪图片 — 免费社媒裁剪工具 | ImgSplit", description: "在线裁剪图片到精确社媒尺寸。支持 Instagram、YouTube、Facebook、X、LinkedIn 预设。免费、隐私安全、浏览器端处理。", ogTitle: "在线裁剪图片 — 免费社媒裁剪工具", ogDescription: "在浏览器中裁剪照片到社媒尺寸，无需上传。" },
    hero: { overline: "图片裁剪工具", headlinePart1: "在线裁剪", headlineAccent: "图片", headlinePart2: "精确尺寸", description: "将任意图片调整并裁剪到精确社媒尺寸。选择预设、拖动定位、应用裁剪，然后在本地导出。" },
    scenarios: [
      { icon: "Crop", title: "精确比例", description: "锁定正方形、竖版或宽屏比例，发布前就能匹配平台要求。" },
      { icon: "Smartphone", title: "社媒即用", description: "使用 Instagram 帖子、Story、YouTube 缩略图、Facebook 封面、X 和 LinkedIn 预设。" },
    ],
    howToSteps: [
      { stepNumber: 1, title: "上传图片", description: "打开 Resize 中的裁剪预设，添加 PNG、JPEG 或 WebP 图片。" },
      { stepNumber: 2, title: "选择裁剪预设", description: "选择社媒尺寸或手动选择比例，然后拖动裁剪框。" },
      { stepNumber: 3, title: "下载结果", description: "应用裁剪并下载 PNG、JPEG 或 WebP。" },
    ],
    faqEntries: [
      { question: "这是单独的裁剪编辑器吗？", answer: "不是。它是 Resize 编辑器里的聚焦裁剪流程和社媒预设，因此复用同样的导出和隐私机制。" },
      { question: "图片会上传吗？", answer: "不会。裁剪在浏览器中完成，图片留在你的设备上。" },
      { question: "可以自定义裁剪尺寸吗？", answer: "可以。你可以修改画布尺寸、选择手动比例并自由定位图片。" },
    ],
    relatedTools: [
  ...
  "crop-for-instagram": {
    ...
    category: "use-case",
    seo: { title: "Instagram 图片裁剪 — 免费 1:1 帖子裁剪 | ImgSplit", description: "在线裁剪 Instagram 帖子尺寸。1080 x 1080 正方形预设，可拖动定位，浏览器端私密导出。", ogTitle: "Instagram 图片裁剪 — 免费在线工具", ogDescription: "无需上传即可制作 Instagram 正方形帖子。" },
    ...
    scenarios: [
      { icon: "Crop", title: "正方形动态帖", description: "把横图或竖图转成干净的 1:1 Instagram 帖子，无需猜比例。" },
      { icon: "Smartphone", title: "移动端分享", description: "在浏览器里先准备好图片，再发送到手机或发布工具。" },
    ],
    howToSteps: [
      { stepNumber: 1, title: "上传照片", description: "从 Instagram 帖子预设开始并添加图片。" },
      { stepNumber: 2, title: "调整裁剪", description: "拖动图片或裁剪框，让主体适合正方形画面。" },
      { stepNumber: 3, title: "下载", description: "应用裁剪并保存 Instagram 尺寸图片。" },
    ],
    faqEntries: [
      { question: "这个预设是什么尺寸？", answer: "Instagram 帖子预设使用 1080 x 1080 像素，比例为 1:1。" },
      { question: "也能裁剪竖版 Instagram 帖子吗？", answer: "可以用 Resize 的自定义尺寸，或用 Story 预设处理 9:16 竖版内容。" },
      { question: "裁剪会降低质量吗？", answer: "工具会按你选择的画布尺寸导出。Instagram 帖子预设的目标输出是 1080 x 1080。" },
    ],
    relatedTools: [
  ...
  "instagram-story-crop": {
    ...
    category: "use-case",
    seo: { title: "Instagram Story 裁剪 — 免费 9:16 图片裁剪 | ImgSplit", description: "在线裁剪 Instagram Story 尺寸。1080 x 1920 竖版预设，浏览器端私密编辑，即时下载。", ogTitle: "Instagram Story 裁剪 — 免费 9:16 裁剪", ogDescription: "用 1080 x 1920 预设在浏览器中裁剪竖版 Story。" },
    ...
    faqEntries: [
      ...
      { question: "可以保留完整图片不裁剪吗？", answer: "可以使用适应模式，让完整图片可见并保留空白区域。" },
    ],
    relatedTools: [
  ...
  "youtube-thumbnail-crop": {
    ...
    category: "use-case",
    seo: { title: "YouTube 缩略图裁剪 — 免费 1280x720 裁剪 | ImgSplit", description: "在线裁剪 YouTube 缩略图尺寸。1280 x 720 16:9 预设，浏览器端处理，无需上传，即时导出。", ogTitle: "YouTube 缩略图裁剪 — 免费 16:9 裁剪", ogDescription: "在浏览器中裁剪 1280 x 720 缩略图。" },
