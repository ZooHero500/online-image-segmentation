...
const data: Record<string, ToolPageData> = {
  ...
  "crop-image": {
    ...
    category: "use-case",
    seo: {
      title: "Crop Image Online — Free Social Crop Tool | ImgSplit",
      description: "Crop images online to exact social media sizes. Instagram, YouTube, Facebook, X, and LinkedIn presets. Free, private, browser-based.",
      ogTitle: "Crop Image Online — Free Social Crop Tool",
      ogDescription: "Crop photos to social media sizes in your browser. No upload needed.",
    },
    hero: {
      overline: "Image Crop Tool",
      headlinePart1: "Crop Images",
      headlineAccent: "Online",
      headlinePart2: "— Exact Sizes",
      description: "Resize and crop any image to precise social media dimensions. Pick a preset, position the photo, apply the crop, and export without uploading your file.",
    },
    scenarios: [
      { icon: "Crop", title: "Exact Aspect Ratios", description: "Lock the crop to square, vertical, or widescreen ratios so your export matches the platform before you post." },
      { icon: "Smartphone", title: "Social Media Ready", description: "Use presets for Instagram posts, stories, YouTube thumbnails, Facebook covers, X posts, and LinkedIn posts." },
    ],
    howToSteps: [
      { stepNumber: 1, title: "Upload Your Image", description: "Open the crop preset in Resize and add your PNG, JPEG, or WebP image." },
      { stepNumber: 2, title: "Choose a Crop Preset", description: "Select a social size preset or manually choose a crop ratio, then drag the crop box into place." },
      { stepNumber: 3, title: "Download the Crop", description: "Apply the crop and download the final image as PNG, JPEG, or WebP." },
    ],
    faqEntries: [
      { question: "Is this a separate crop editor?", answer: "No. It is the Resize editor with a focused crop workflow and social media presets, so the same export and privacy behavior applies." },
      { question: "Will my image be uploaded?", answer: "No. Cropping runs in your browser. Your image stays on your device." },
      { question: "Can I use a custom crop size?", answer: "Yes. You can change the canvas dimensions, pick a manual crop ratio, and position the image freely." },
    ],
    relatedTools: [
  ...
  "crop-for-instagram": {
    ...
    category: "use-case",
    seo: {
      title: "Crop Image for Instagram — Free 1:1 Post Cropper | ImgSplit",
      description: "Crop images to Instagram post size online. 1080 x 1080 square preset, drag-to-position crop box, private browser-based export.",
      ogTitle: "Crop Image for Instagram — Free Online Tool",
      ogDescription: "Make square Instagram posts without uploading your photo.",
    },
    hero: {
      overline: "Instagram Crop Tool",
      headlinePart1: "Crop for",
      headlineAccent: "Instagram",
      headlinePart2: "— 1:1 Posts",
      description: "Create clean 1080 x 1080 Instagram post crops from any image. Keep the important subject centered and export a platform-ready square.",
    },
    scenarios: [
      { icon: "Crop", title: "Square Feed Posts", description: "Turn portrait or landscape photos into clean 1:1 Instagram posts without guessing the ratio." },
    ...
    howToSteps: [
      { stepNumber: 1, title: "Upload Your Photo", description: "Start from the Instagram post preset and add your image." },
    ...
    faqEntries: [
      { question: "What size does this preset use?", answer: "The Instagram post preset uses 1080 x 1080 pixels with a 1:1 crop ratio." },
      { question: "Can I crop vertical Instagram posts too?", answer: "Use the main Resize tool for custom dimensions, or use the Story preset for 9:16 vertical content." },
  ...
  "instagram-story-crop": {
    ...
    category: "use-case",
    seo: {
      title: "Instagram Story Crop — Free 9:16 Image Cropper | ImgSplit",
      description: "Crop images to Instagram Story size online. 1080 x 1920 vertical preset, private browser-based editing, instant download.",
      ogTitle: "Instagram Story Crop — Free 9:16 Cropper",
      ogDescription: "Crop vertical stories in your browser with a 1080 x 1920 preset.",
    },
    hero: {
      overline: "Instagram Story Crop",
      headlinePart1: "Crop Instagram",
      headlineAccent: "Stories",
      headlinePart2: "— 9:16 Vertical",
      description: "Prepare full-screen Instagram stories with a 1080 x 1920 crop preset. Reposition the image, apply the crop, and export privately.",
    },
    scenarios: [
    ...
    faqEntries: [
      ...
      { question: "Can I keep the full image instead of cropping?", answer: "Use Fit mode if you want the full image visible with empty space instead of filling the full frame." },
    ],
    relatedTools: [
  ...
  "youtube-thumbnail-crop": {
    ...
    category: "use-case",
    seo: {
      title: "YouTube Thumbnail Crop — Free 1280x720 Cropper | ImgSplit",
      description: "Crop images to YouTube thumbnail size online. 1280 x 720 16:9 preset, browser-based, no upload, instant PNG/JPEG/WebP export.",
      ogTitle: "YouTube Thumbnail Crop — Free 16:9 Cropper",
      ogDescription: "Crop thumbnail images to 1280 x 720 in your browser.",
    },
    hero: {
      overline: "YouTube Thumbnail Crop",
      headlinePart1: "Crop YouTube",
      headlineAccent: "Thumbnails",
      headlinePart2: "— 16:9",
      description: "Create 1280 x 720 YouTube thumbnail crops from any image. Use the 16:9 preset, place your subject, and export a ready-to-upload thumbnail.",
    },
    scenarios: [
