...
const data: Record<string, ToolPageData> = {
  ...
  "crop-image": {
    slug: "crop-image",
    category: "use-case",
    seo: { title: "온라인 이미지 자르기 — 무료 소셜 크롭 도구 | ImgSplit", description: "Instagram, YouTube, Facebook 등 소셜 크기에 맞춰 이미지를 자르세요. 무료, 비공개, 브라우저 기반.", ogTitle: "온라인 이미지 자르기", ogDescription: "브라우저에서 소셜 크기로 사진을 자르세요." },
    ...
    scenarios: [
      { icon: "Crop", title: "정확한 비율", description: "정사각형, 세로, 와이드 비율을 고정해 내보냅니다." },
      { icon: "Smartphone", title: "소셜 준비", description: "Instagram 게시물/스토리, YouTube 썸네일, Facebook 커버 프리셋을 사용할 수 있습니다." },
    ],
    howToSteps: [
      { stepNumber: 1, title: "이미지 업로드", description: "Resize를 열고 PNG, JPEG 또는 WebP 이미지를 추가하세요." },
      { stepNumber: 2, title: "프리셋 선택", description: "소셜 크기 프리셋을 선택한 뒤 Crop으로 보이는 영역을 조정하세요." },
      { stepNumber: 3, title: "다운로드", description: "자르기를 적용하고 PNG, JPEG 또는 WebP로 저장하세요." },
    ],
    faqEntries: [
      { question: "별도 자르기 에디터인가요?", answer: "아닙니다. Resize 에디터의 소셜 프리셋과 자르기 기능입니다." },
      { question: "이미지가 업로드되나요?", answer: "아닙니다. 처리는 브라우저에서 이루어지며 이미지는 기기에 남습니다." },
      { question: "사용자 정의 크기도 가능한가요?", answer: "예. 캔버스 크기와 자르기 비율을 수동으로 변경할 수 있습니다." },
    ],
    relatedTools: [
  ...
  "crop-for-instagram": {
    ...
    scenarios: [
      { icon: "Crop", title: "정사각형 피드 게시물", description: "가로 또는 세로 사진을 1:1 게시물로 변환합니다." },
      { icon: "Smartphone", title: "모바일 공유", description: "휴대폰이나 예약 게시 도구로 보내기 전에 브라우저에서 준비하세요." },
    ],
    howToSteps: [
      { stepNumber: 1, title: "사진 업로드", description: "Instagram 정사각형 프리셋에서 이미지를 추가하세요." },
    ...
    faqEntries: [
      { question: "프리셋 크기는 무엇인가요?", answer: "Instagram 정사각형 프리셋은 1080 x 1080 픽셀, 1:1 비율입니다." },
      { question: "세로 콘텐츠도 가능한가요?", answer: "9:16 콘텐츠에는 Story 프리셋을 사용하거나 Resize에서 사용자 정의 크기를 설정하세요." },
  ...
  "instagram-story-crop": {
    ...
    category: "use-case",
    seo: { title: "Instagram Story 자르기 — 무료 9:16 크롭 도구 | ImgSplit", description: "Instagram Story 크기로 온라인 자르기. 1080 x 1920 세로 프리셋, 브라우저 기반 편집.", ogTitle: "Instagram Story 자르기", ogDescription: "1080 x 1920 프리셋으로 세로 Story 만들기." },
