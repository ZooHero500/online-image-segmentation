...
const data: Record<string, ToolPageData> = {
  ...
  "crop-image": {
    slug: "crop-image",
    category: "use-case",
    seo: { title: "Recortar Imagen Online — Herramienta Social Gratis | ImgSplit", description: "Recorta imágenes a tamaños exactos para Instagram, YouTube, Facebook, X y LinkedIn. Gratis, privado y en el navegador.", ogTitle: "Recortar Imagen Online", ogDescription: "Recorta fotos a tamaños sociales sin subir archivos." },
    ...
    scenarios: [
      { icon: "Crop", title: "Proporciones Exactas", description: "Bloquea proporciones cuadradas, verticales o panorámicas antes de publicar." },
      { icon: "Smartphone", title: "Listo para Redes", description: "Usa preajustes para Instagram, historias, YouTube, Facebook, X y LinkedIn." },
    ],
    howToSteps: [
      { stepNumber: 1, title: "Sube tu Imagen", description: "Abre el preajuste de recorte en Resize y añade una imagen PNG, JPEG o WebP." },
      { stepNumber: 2, title: "Elige un Preajuste", description: "Selecciona un tamaño social o una proporción manual, luego arrastra el marco de recorte." },
      { stepNumber: 3, title: "Descarga", description: "Aplica el recorte y guarda como PNG, JPEG o WebP." },
    ],
    faqEntries: [
      { question: "¿Es un editor de recorte separado?", answer: "No. Es el editor Resize con un flujo de recorte enfocado y preajustes sociales." },
      { question: "¿Se sube mi imagen?", answer: "No. El recorte ocurre en tu navegador y la imagen permanece en tu dispositivo." },
      { question: "¿Puedo usar un tamaño personalizado?", answer: "Sí. Puedes cambiar las dimensiones del lienzo, elegir una proporción manual y posicionar la imagen libremente." },
    ],
    relatedTools: [
  ...
  "crop-for-instagram": {
    ...
    category: "use-case",
    seo: { title: "Recortar Imagen para Instagram — Gratis 1:1 | ImgSplit", description: "Recorta imágenes al tamaño de publicación de Instagram. Preajuste 1080 x 1080, ajuste por arrastre y exportación privada.", ogTitle: "Recortar Imagen para Instagram", ogDescription: "Crea publicaciones cuadradas sin subir tu foto." },
    ...
    scenarios: [
      { icon: "Crop", title: "Feed Cuadrado", description: "Convierte fotos horizontales o verticales en publicaciones 1:1 sin adivinar la proporción." },
    ...
    howToSteps: [
      { stepNumber: 1, title: "Sube tu Foto", description: "Empieza desde el preajuste de publicación de Instagram y añade tu imagen." },
    ...
    faqEntries: [
      { question: "¿Qué tamaño usa este preajuste?", answer: "1080 x 1080 píxeles con proporción 1:1." },
      { question: "¿Puedo recortar publicaciones verticales?", answer: "Usa Resize para dimensiones personalizadas o el preajuste Story para contenido 9:16." },
  ...
  "instagram-story-crop": {
    ...
    category: "use-case",
    seo: { title: "Recorte Instagram Story — Gratis 9:16 | ImgSplit", description: "Recorta imágenes al tamaño de Instagram Story. Preajuste vertical 1080 x 1920, edición privada en navegador y descarga instantánea.", ogTitle: "Recorte Instagram Story", ogDescription: "Crea historias verticales con preajuste 1080 x 1920." },
